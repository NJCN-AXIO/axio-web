...
const solutions = [
  {
    ...
    points: ["多来源选品与任务配置", "多站点定价口径", "标准客户端交付"],
  },
  {
    audience: "成长团队",
    scale: "团队协同",
  ...
  },
  {
    ...
    points: ["矩阵分组与多站点运营", "业务结果回读", "源码或私有化部署规划"],
  },
] as const;
    ...
    <main className="marketing-page">
      <section className="marketing-hero">
        <div className="marketing-hero__inner">
          <div>
            <p className="marketing-eyebrow">SOLUTIONS / OPERATING MODEL</p>
            <h1>按经营阶段扩展自动化</h1>
            <p className="marketing-hero__lead">
              业务逐步扩展时，团队真正需要调整的是任务边界、协作方式与结果验收，而不只是增加自动化次数。
            </p>
          </div>
          <aside className="marketing-hero__aside">
            <strong>按真实经营阶段规划交付</strong>
            <p>站点范围、流程复杂度和团队职责共同决定适配路径。</p>
          </aside>
        </div>
      </section>
