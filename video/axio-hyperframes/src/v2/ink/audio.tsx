...
export const SFX: Record<Format, SfxCue[]> = {
  website: [
    ...
    sfx('website', 'outro-riser', 'air-whoosh-powerful.mp3', 0.34, 80),
    sfx('website', 'outro-impact', 'impact-deep-whoosh.mp3', 0.5),
    sfx('website', 'outro-sparkle', 'shimmer-sparkle-sweep.mp3', 0.34, 26),
  ],
  wechat: [
    ...
    sfx('wechat', 'outro-riser', 'air-whoosh-powerful.mp3', 0.34, 58),
    sfx('wechat', 'outro-impact', 'impact-deep-whoosh.mp3', 0.5),
    sfx('wechat', 'outro-sparkle', 'shimmer-sparkle-sweep.mp3', 0.34, 26),
  ],
};
