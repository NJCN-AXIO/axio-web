...
const renders = [
  {
    id: "website",
    path: join(root, "out", "AXIO-website-v2-4k.mp4"),
    width: 3840,
    height: 2160,
    duration: [82, 88],
    sampleFrames: [0, 150, 420, 600, 840, 1440, 1860, 2160, 2415, 2540],
  },
  {
    id: "wechat",
    path: join(root, "out", "AXIO-wechat-v2-vertical.mp4"),
    width: 1080,
    height: 1920,
    duration: [48, 52],
    sampleFrames: [0, 240, 420, 900, 1200, 1490],
  },
];
